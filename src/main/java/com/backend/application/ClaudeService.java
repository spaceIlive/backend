...
public class ClaudeService {
    ...
    private String createAnalysisPrompt() {
        ...
        **중요: 반드시 아래 형식으로만 응답하세요! 다른 말은 하지 마세요!**
        ...
        스케치든 사진이든 상관없이, 무엇을 나타내는지 추측하고 그림을 평가해주세요.
        ...
        **형식을 정확히 지켜서 응답하세요:**
        ...
        - 창의성 점수: [0-100점]
        - 전체 평가 점수: [0-100점]
        - 종합 평가 이유: [전체 점수에 대한 설명]
        
        **평가 기준:**
        - 그림 품질 점수: 선의 정확성, 비례, 완성도, 세밀함 등
        - 창의성 점수: 독창적 표현, 아이디어, 색상/구성의 참신함 등
        - 전체 평가 점수: 품질과 창의성을 종합한 전반적 평가
        ...
        **예시:**
        ...
        - 창의성 점수: 60점
        - 전체 평가 점수: 70점
        - 종합 평가 이유: 기본적인 형태는 잘 표현했으나 세부적인 음영이나 질감 표현이 부족합니다
